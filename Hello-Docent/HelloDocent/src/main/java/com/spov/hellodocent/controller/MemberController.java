...
public class MemberController {
	...
	public String join(HttpServletResponse response, Model model) {
		...
		System.out.println("도슨트 암호화");
		System.out.println((String)new EncryptoString().Encrypto("docent"));
	...
	public String updateMember(@RequestBody Map<String, String> param) {
		...
		removeFile.add(param.get("profilePhoto"));
		String removeDir = uploadPath+(param.get("profilePhoto").substring(4));
		manager.removeOtherFiles(removeFile, removeDir);
