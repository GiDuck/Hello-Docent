  ...
  <nav class="navbar navbar-expand-lg nav-down navbar-absolute navbar-transparent" id="basic_navbar">
    <div class="container">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="dropdown nav-item">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-danger" aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item" href="/display/findDisplay?prefix=0&suffix=20&keyword=">
	 ...
	 <li class="dropdown nav-item">
          ...
          <c:if test="${empty sessionScope.userVO ? false : true}">
          
          
          <li id="MyInfo" class="dropdown nav-item">
            <a class="dropdown-toggle nav-link" id="navbarDropdownMenuLink2" data-toggle="dropdown">
              MyInfo
            </a>
            <div class="dropdown-menu dropdown-menu-right dropdown-danger" aria-labelledby="navbarDropdownMenuLink">
          ...
          <c:if test="${sessionScope.userVO.user_isDocent eq 'docent' ? true : false}">
          <li id="docentMenu" class="dropdown nav-item">
            <a class="dropdown-toggle nav-link" id="navbarDropdownMenuLink2" data-toggle="dropdown">
              	도슨트 메뉴
            </a>
            <div class="dropdown-menu dropdown-menu-right dropdown-danger" aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item" href="/display/findDisplayForDocent?prefix=0&suffix=20&token=">
                <i class="nc-icon nc-paper"></i> 해설 만들기
              </a>
              <a class="dropdown-item" href="/blog/blogWriting">
                <i class="nc-icon nc-chat-33"></i> 블로그 작성하기
              </a>
              <a class="dropdown-item" href="/content/getDocentContent">
                <i class="nc-icon nc-world-2"></i> 내 컨텐츠 보기
              </a>
              
            <a class="dropdown-item" href="/docent/getDocentInfoView">
                <i class="nc-icon nc-alert-circle-i"></i> 도슨트 정보 관리
            </a>
