...
<title>Hello Docent - 500 error</title>
...
<body>
  ...
  <div class="background-img" style="background-image: url('${pageContext.request.contextPath}/resources/assets/img/korea/snow_korea.jpg')">
    <div class="filter"></div>
    <div class="container">
      <div class="row">
        <h1 class="title"> &nbsp;500
          <br/>
          <p class="error-msg">잠시 작은 문제가 생겼다네요..!</p>
        </h1>
      </div>
      <div class="container-cards space-top">
        <div class="row">
          <h3 class="discover-pages text-center"><a href="/">돌아가기</a></h3>
        </div>
