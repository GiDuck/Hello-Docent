              ...
              <div class="col-12">
                <div class="card card-blog card-plain text-center w-100">
                  <div id="blogImage" class="card-image">
                      <img class="img img-raised" name="${blog.COL_ID}" src="" onError='this.onerror=null;this.src="${pageContext.request.contextPath}/resources/assets/img/defaults/noimage1.png"'></div>
                  <div class="card-body">
