    ...
    <div class="main">
        ...
        <div class="container">
          ...
          <div class="row">
                  ...
                  <div class="media">
                    <a class="pull-left" href="#paper-kit">
                      <div class="avatar big-avatar">
                        ...
                        src="${pageContext.request.contextPath}/resources/assets/img/faces/kaci-baum-2.jpg">
                      </div>
                    </a>
           ...
           <!-------------------- 일반 댓글 Dummy ------------------->
                      ...
                      <a class="pull-left">
                        <div class="avatar">
                          <img id="reply_writer_photo" id="reply_writer_photo" 
                          onError='this.onerror=null;this.src="${pageContext.request.contextPath}/resources/assets/img/defaults/noimage1.png"'
                          class="media-object" alt="64x64" src="${pageContext.request.contextPath}/resources/assets/img/defaults/noimage_people.png">
                        </div>
                      </a>
         ...
         <!-------------------- 대댓글이 달리는 원 댓글 Dummy ------------------->
            ...
            <div class="media w-100" id="refReplyOriginDummy" style="display:none;">
                    ...
                    <div class="media-body">              
	                 ...
	                 <a class="pull-left">
                        <div class="avatar">
                          <img id="reply_writer_photo" class="media-object" 
                          onError='this.onerror=null;this.src="${pageContext.request.contextPath}/resources/assets/img/defaults/noimage1.png"'
                          alt="profile" src="${pageContext.request.contextPath}/resources/assets/img/defaults/noimage_people.png">
                        </div>
                      </a>
      ...
      <!-------------------- 대댓글 Dummy ------------------->
                ...
                <div class="media" id="refReplyDummy" style="display:none;" >
                         ...
                         <a class="pull-left">
                           <div class="avatar">
                              <img id="reply_writer_photo" class="media-object" alt="64x64" 
                              onError='this.onerror=null;this.src="${pageContext.request.contextPath}/resources/assets/img/defaults/noimage1.png"'
                              src="${pageContext.request.contextPath}/resources/assets/img/defaults/noimage_people.png">
                            </div>
                          </a>
