  ...
  <div class="main add-product">
    <div class="section">
      ...
      <div class="row" style="margin:20px">
        ...
        <img src="${params.DPL_IMAGEURL}"  onError='this.onerror=null;this.src="${pageContext.request.contextPath}/resources/assets/img/defaults/noimage1.png"'
        ...
        <div class="col-12"><h6>${params.EP_NAME}</h6></div>
              ...
              <div class="row price-row">
                <div class="col-md-6">
                  ...
                  <div class="input-group border-input">
                    <input id="co_date" type="text" value=<fmt:formatDate value="${comInfo.CMT_DATE}" pattern="yyyy-MM-dd"/> class="form-control border-input" readonly="readonly">
          ...
          var froala =  $('#editor').froalaEditor({
		        ...
		        imageUploadParams: {boardUid: '${display_uid}', id : '${comInfo.CMT_ID}'},
...
/*             .on('froalaEditor.image.removed', function (e, editor, $img) {
  ...
  function initControl(){
	  ...
	  $("#co_title").val('${comInfo.CMT_TITLE}');
	  $("#co_introduce").val('${comInfo.CMT_INTRODUCE}');
	  
	  
		//content type init
	  $("#content_type option").each(function(index, element){
		    
	 	if($(element).val() === '${comInfo.CMT_CONTENTTYPE}'){
		...
		$("input [value='free_or_cost']").each(function(index, element){
			
			console.log("index " + index);
			
			if($(element).val() === '${comInfo.CMT_ISFREE}'){
		...
		$("#credit_select option").each(function(index, element){
		...
		console.log("content : " + '${comInfo.CMT_CONTENT}');
		froala.froalaEditor('html.set','${comInfo.CMT_CONTENT}');
	...
	$("#btn_submit").on('click', function(){
		...
		var param = {
				...
				CMT_ID : '${comInfo.CMT_ID}',
				CMT_REF : '${comInfo.CMT_REF}',
				CMT_WRITERUID : '${comInfo.CMT_WRITERUID}',
				CMT_TITLE : title,
				CMT_INTRODUCE : introduce,
				CMT_ISFREE : costType,
				CMT_CONTENTTYPE : type,
				CMT_DATE : '${comInfo.CMT_DATE}',
				CMT_CONTENT : sethtml,
		...
		$.ajax({
			type : "POST",
			url : "/commentary/commentaryModify",
