...
<title>Hello Docent - 400/415 error</title>
...
<body>
  ...
  <div class="background-img" style="background-image: url('${pageContext.request.contextPath}/resources/assets/img/korean/wall_korea.jpg')">
    ...
    <div class="container" style="height:100%">
      ...
      <div class="row">
        ...
        <h2 class="title"> &nbsp;400 or 415
          <br/>
          <p class="error-msg">통행증이 없군요! 누가 당신을 여기로 보냈나요?</p>
        </h2>
      </div>
...
<div class="row" style="height:50px"></div>
      ...
      <div class="container-cards">
        <div class="row">
      <h5 class="discover-pages text-center"><a href="/">돌아가기</h5></a>
          <br/>
          <br/>
          <br/>
        </div>
