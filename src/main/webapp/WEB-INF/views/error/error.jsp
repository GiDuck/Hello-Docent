...
<title>Hello Docent - error</title>
<meta
...
<body>
	...
	<div class="background-img"
		style="background-image: url('${pageContext.request.contextPath}/resources/assets/img/korean/house_korea.jpg')">
		...
		<div class="container" style="height: 100%">
			...
			<div class="row">
				...
				<h2 class="title">
					&nbsp;error <br />
					<p class="error-msg">무슨 일이 일어났는지 저도 잘 모르겠어요.</p>
				</h2>
			</div>
			...
			<div class="container-cards">
				<div class="row">
					<h5 class="discover-pages text-center">
						<a href="/">돌아가기
					</h5>
					</a> <br /> <br /> <br />
				</div>
	...
	<script src="${pageContext.request.contextPath}/resources/assets/js/plugins/nouislider.min.js"
	...
	<script src="${pageContext.request.contextPath}/resources/assets/js/plugins/bootstrap-selectpicker.js"
		type="text/javascript"></script>
	<!--	Plugin for Datetimepicker, full documentation here: https://eonasdan.github.io/bootstrap-datetimepicker/ -->
	<script src="${pageContext.request.contextPath}/resources/assets/js/plugins/bootstrap-datetimepicker.js"
		type="text/javascript"></script>
	<!--  Vertical nav - dots -->
	<!--  Photoswipe files -->
