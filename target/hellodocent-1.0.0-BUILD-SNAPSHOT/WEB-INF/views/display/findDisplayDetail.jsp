...
<body class="product-page sidebar-collapse">
  ...
  <div class="page-header page-header-xs" style="background-image: url('https://cdn.pixabay.com/photo/2016/02/27/12/40/sculpture-1225487_1280.jpg');">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-7 col-sm-6" style="display:flex; align-items:center; ">
            ...
            <img src="${scheme}${disInfo.DPL_IMAGEURL}"
