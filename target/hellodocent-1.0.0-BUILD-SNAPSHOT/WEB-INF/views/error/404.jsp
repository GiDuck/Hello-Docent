...
<title>Hello Docent - 404 error</title>
<meta
...
<body>
	...
	<div class="background-img"
		style="background-image: url('${pageContext.request.contextPath}/resources/assets/img/korean/knock.jpg')">
		...
		<div class="container" style="height: 100%">
			...
			<div class="row">
				...
				<h2 class="title">
					&nbsp;404 <br />
					<p class="error-msg">초면인걸 보니 길을 잘못 드신 것 같네요.</p>
				</h2>
			</div>
