				...
				<div class="center-block">
					<div class="row">
						<div class="col-sm-9" style="padding: 8px">
							<input class="form-control form-control-lg center-block "
					...
					<c:forEach var="temp" items="${events}" begin="1" end="12">
						...
						<div class="col-md-3">
							<div class="card" style="width: 100%;" id="${temp.de_url}">
								<img class="card-img-top" src="${image_container}" onError="this.onerror=null;this.src='${pageContext.request.contextPath}/resources/assets/img/defaults/noimage1.png';">
								<div class="card-body">
