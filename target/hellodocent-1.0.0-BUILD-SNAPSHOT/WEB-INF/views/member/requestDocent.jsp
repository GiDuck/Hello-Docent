          ...
          <div class="col-md-6 ml-auto mr-auto text-center">
            ...
            <form class="contact">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <input type="text" class="form-control" placeholder="Professional">
                </div>
              </div>
              <textarea class="form-control" placeholder="간단한 자기소개를 적어주세요." rows="7"></textarea>
              <div class="row">
                <div class="col-md-6 ml-auto mr-auto">
                  <button id="submitBtn" class="btn btn-primary btn-block btn-round">Send </button>
                </div>
              </div>
            </form>
            <h3 class="visit">
